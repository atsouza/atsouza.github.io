...
const translations = {
    en: {
        ...
        "about.text1": "Full Stack Developer with solid experience in design, development and maintenance of scalable systems, using technologies such as .NET Core, ReactJS, SQL Server and AWS. I possess strong ability in planning architectural technical solutions and applying rigorous software engineering practices.",
        "about.text2": "Experienced in agile methodologies, I stand out for my ease of communication with stakeholders and multidisciplinary and international teams, translating business needs into efficient technological solutions.",
    ...
    pt: {
        ...
        "about.text1": "Desenvolvedor Full Stack com sólida experiência no design, desenvolvimento e manutenção de sistemas escaláveis, utilizando tecnologias como .NET Core, ReactJS, SQL Server e AWS. Possuo forte habilidade no planejamento de soluções técnicas arquiteturais e na aplicação de rigorosas práticas de engenharia de software.",
        "about.text2": "Experiente em metodologias ágeis, destaco-me pela facilidade de comunicação com stakeholders e equipes multidisciplinares e internacionais, traduzindo necessidades de negócios em soluções tecnológicas eficientes.",
